...
~/.acme.sh/acme.sh --issue --dns -d $DOMAIN --keylength 4096 --yes-I-know-dns-manual-mode-enough-go-ahead-please
read -r -p "Please add the TXT record to your DNS records: " -e -i "please enter YES!" YYY
